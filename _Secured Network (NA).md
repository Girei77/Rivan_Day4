...
ifconfig ens256 10.72.1.6 netmask 255.255.255.0 up
~~~
...
ifname ens256 \
ipv4.method manual \
ipv4.addresses 10.72.1.6/24 \
autoconnect yes

nmcli connection up BRIDGED

ip route add 10.0.0.0/8 via 10.72.1.4 dev ens256
ip route add 200.0.0.0/24 via 10.72.1.4 dev ens256
...
conf t
 ip access-list extended NAT-POLICY
  ...
  deny ip 10.72.0.0 0.0.255.255 10.12.0.0 0.0.255.255
  deny ip 10.72.0.0 0.0.255.255 10.21.0.0 0.0.255.255
  deny ip 10.72.0.0 0.0.255.255 10.22.0.0 0.0.255.255
  deny ip 10.72.0.0 0.0.255.255 10.31.0.0 0.0.255.255
  deny ip 10.72.0.0 0.0.255.255 10.32.0.0 0.0.255.255
  deny ip 10.72.0.0 0.0.255.255 10.41.0.0 0.0.255.255
  deny ip 10.72.0.0 0.0.255.255 10.42.0.0 0.0.255.255
  deny ip 10.72.0.0 0.0.255.255 10.51.0.0 0.0.255.255
  deny ip 10.72.0.0 0.0.255.255 10.52.0.0 0.0.255.255
  deny ip 10.72.0.0 0.0.255.255 10.61.0.0 0.0.255.255
  deny ip 10.72.0.0 0.0.255.255 10.62.0.0 0.0.255.255
  deny ip 10.72.0.0 0.0.255.255 10.71.0.0 0.0.255.255
  deny ip 10.72.0.0 0.0.255.255 10.72.0.0 0.0.255.255
  deny ip 10.72.0.0 0.0.255.255 10.81.0.0 0.0.255.255
  deny ip 10.72.0.0 0.0.255.255 10.82.0.0 0.0.255.255
  deny ip 10.72.0.0 0.0.255.255 10.91.0.0 0.0.255.255
  deny ip 10.72.0.0 0.0.255.255 10.92.0.0 0.0.255.255
  no deny ip 10.72.0.0 0.0.255.255 10.72.0.0 0.0.255.255
  permit ip any any
  end
~~~
...
conf t
 ...
 router ospf 1
  ...
  exit
 ip name-server 10.72.1.10   !8.8.8.8 8.8.4.4
 ip domain lookup
...
conf t
 int tun1
  ip add 172.16.1.72 255.255.255.0
  ...
  no ip nhrp map 172.16.1.72 200.0.0.72
  end
~~~
...
conf t
 ...
 !
 no ip route 10.72.0.0 255.255.0.0 172.16.1.72 252
 end
~~~
...
Review: Create a DNS A record for www.ccna72.com
